...
import { userSettingService } from "@/app/service/httpService/httpServiceProvider.ts";
    ...
    askConfirmation().then(async (result) => {
      if(result.isConfirmed) {
        try {
          ...
          const res = await userSettingService.updateProfile(payload, props.authUser.token);
