...
import ProfileUpdate from "@/modules/userProfile/components/ProfileUpdate.vue";
import ChangePassword from "@/modules/userProfile/components/ChangePassword.vue";
