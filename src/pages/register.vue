...
const confirmPassword = () => {
  isMissMatchPassword.value = form.value.password_confirmation != form.value.password ? true : false;
}
...
const submit = () => {
  if(form.value.name == '' || form.value.email == '' || form.value.password == '' || form.value.password_confirmation == '' || form.value.password != form.value.password_confirmation) {
      ...
      >
        <VCardText>
          <h4 class="text-h4 mb-1">
            Sign Up for <span class="text-capitalize">{{ themeConfig.app.title }}</span>
          </h4>
        </VCardText>
